...
if __name__ == '__main__':
    ...
    cv2.imshow('img', img)
    cv2.imshow('marking', img_marking)
    ...
    # read video file
    output_name = sys.argv[3] + "mask_bonus.png"
    output_marking_name = sys.argv[3] + "marking_bonus.png"
    cv2.imwrite(output_name, np.array(segmask).astype('uint8'))
    cv2.imwrite(output_marking_name, np.array(img_marking).astype('uint8'))
